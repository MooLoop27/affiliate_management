        ...
        <div class="table-container">
            <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-4">
                    <h5 class="fw-bold border-bottom pb-2">General Settings</h5>
                ...
                <div class="row g-3 mb-4">
                    <h5 class="fw-bold border-bottom pb-2">Commission Defaults</h5>
                    ...
                    <div class="col-md-4">
                        <label class="form-label">Default Recipient Commission (%)</label>
                        <div class="input-group">
                ...
                <div class="row g-3 mb-4">
                    <h5 class="fw-bold border-bottom pb-2">Appearance</h5>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="system_theme" class="form-select @error('system_theme') is-invalid @enderror">
                            <option value="light" {{ old('system_theme', $settings->get('system_theme')?->value ?? 'light') === 'light' ? 'selected' : '' }}>Light</option>
                            <option value="dark" {{ old('system_theme', $settings->get('system_theme')?->value ?? 'light') === 'dark' ? 'selected' : '' }}>Dark</option>
                        </select>
